...
tickers = ['MOREPENLAB.NS', 'OMAXE.NS']
...
for t in tickers:
    ...
    print(f"Session Range       : Low INR {last_row['Low']:.2f} - High INR {last_row['High']:.2f}")
    ...
    print(f"ATR (14) Volatility : {atr:.2f} ({(atr/close)*100:.2f}%)")
